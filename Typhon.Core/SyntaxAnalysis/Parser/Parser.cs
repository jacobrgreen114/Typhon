...
public struct SyntaxParserData
{
    ...
    public SyntaxParserData(
        ISyntaxAnalyser analyser, ITokenStream tokenStream, int index = 0
    )
    {
        Analyser = analyser;
    ...
    public SyntaxParserData(SyntaxParserData oldData, int newIndex) : this(
        oldData.Analyser, oldData.TokenStream, newIndex
    )
    {
    }
}
